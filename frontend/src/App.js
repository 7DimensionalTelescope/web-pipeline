...
function App() {
    ...
    const [activeTab, setActiveTab] = useState('overview'); // 'overview', 'queue', 'pipeline', or 'qa'
                ...
                <>
                    ...
                    <footer className="footer">
                        <div className="footer-content">
                            <p>
                                This pipeline operates using the updated 7DT Pipeline (aka py7dt v1.0 {' '}
                                <a href="https://github.com/7DimensionalTelescope/pipeline" target="_blank" rel="noopener noreferrer">GitHub</a>)
                                and is supported by Web Application v1.0 (see{' '}
